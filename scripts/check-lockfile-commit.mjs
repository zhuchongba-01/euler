...
const allowValue = process.env.EULER_ALLOW_LOCKFILE_CHANGE;
...
if (allowed) {
	console.error("package-lock.json is staged; EULER_ALLOW_LOCKFILE_CHANGE is set, allowing commit.");
	process.exit(0);
}
...
console.error("  EULER_ALLOW_LOCKFILE_CHANGE=1 git commit ...");
process.exit(1);
