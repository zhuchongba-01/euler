 ...
 *
 * Existing apps switch imports from "@zhongchongba/euler-ai" to
 * "@zhongchongba/euler-ai/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@zhongchongba/euler-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@zhongchongba/euler-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@zhongchongba/euler-ai/providers/all" or `Models.getProviders()`. */
