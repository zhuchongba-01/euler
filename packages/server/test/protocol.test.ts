import type { Api, AssistantMessage, Model, ToolCall, ToolResultMessage, UserMessage } from "@zhongchongba/euler-ai";
import { encodeServerMessage, PROTOCOL_VERSION } from "@zhongchongba/euler-protocol";
