import type { StreamFn } from "@zhongchongba/euler-agent-core";
import { type AssistantMessage, createAssistantMessageEventStream, fauxAssistantMessage } from "@zhongchongba/euler-ai";
