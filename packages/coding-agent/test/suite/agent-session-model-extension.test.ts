import type { AgentTool, ThinkingLevel } from "@zhongchongba/euler-agent-core";
import { fauxAssistantMessage, fauxToolCall, type Model, type Usage } from "@zhongchongba/euler-ai";
