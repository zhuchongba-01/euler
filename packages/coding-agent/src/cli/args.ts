...
import type { ThinkingLevel } from "@zhongchongba/euler-agent-core";
...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} update [source|self]      Update Euler, extensions, or model catalogs
...
${chalk.bold("Options:")}
  ...
  --offline                      Disable startup network operations (same as EULER_OFFLINE=1)
...
${chalk.bold("Environment Variables:")}
  ...
  EULER_PACKAGE_DIR                - Override package directory (for Nix/Guix store paths)
  EULER_OFFLINE                    - Disable startup network operations when set to 1/true/yes
  EULER_SHARE_VIEWER_URL           - Base URL for /share command
