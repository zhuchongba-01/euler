...
import { type ImageContent, type Message, type TextContent, type Usage, uuidv7 } from "@zhongchongba/euler-ai";
 ...
 * Encodes cwd into a safe directory name under ~/.euler/agent/sessions/.
 */
...
export class SessionManager {
	...
	private _setSessionFile(sessionFile: string, preloadedFileEntries?: FileEntry[]): void {
		...
		if (existsSync(this.sessionFile)) {
			...
			// non-empty but did not parse as a valid session, fail without modifying it.
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.euler/agent/sessions/<encoded-cwd>/).
	 */
