...
import { Agent, type AgentMessage, setDefaultStreamFn, type ThinkingLevel } from "@zhongchongba/euler-agent-core";
import { clampThinkingLevel, type Message, type Model, streamSimple } from "@zhongchongba/euler-ai/compat";
...
export interface CreateAgentSessionOptions {
	...
	cwd?: string;
	/** Global config directory. Default: ~/.euler/agent */
	agentDir?: string;
