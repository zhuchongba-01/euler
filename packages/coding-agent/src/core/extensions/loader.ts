...
import * as _bundledPiAgentCore from "@zhongchongba/euler-agent-core";
import type { Provider } from "@zhongchongba/euler-ai";
import * as _bundledPiAiCompat from "@zhongchongba/euler-ai/compat";
import * as _bundledPiAiOauth from "@zhongchongba/euler-ai/oauth";
import * as _bundledPiAiProviders from "@zhongchongba/euler-ai/providers/all";
import type { KeyId } from "@zhongchongba/euler-tui";
import * as _bundledPiTui from "@zhongchongba/euler-tui";
...
// avoiding a circular dependency. Extensions can import from euler-agent.
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@zhongchongba/euler-agent-core": _bundledPiAgentCore,
	"@zhongchongba/euler-tui": _bundledPiTui,
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	"@zhongchongba/euler-ai": _bundledPiAiCompat,
	"@zhongchongba/euler-ai/compat": _bundledPiAiCompat,
	"@zhongchongba/euler-ai/oauth": _bundledPiAiOauth,
	"@zhongchongba/euler-ai/providers/all": _bundledPiAiProviders,
	"euler-agent": _bundledPiCodingAgent,
};
...
declare const EULER_BUNDLED_NODE: boolean;
const isBundledNode = typeof EULER_BUNDLED_NODE !== "undefined" && EULER_BUNDLED_NODE;
...
function getAliases(): Record<string, string> {
	...
	const piAgentCoreEntry = resolveWorkspaceOrImport("agent/dist/index.js", "@zhongchongba/euler-agent-core");
	const piTuiEntry = resolveWorkspaceOrImport("tui/dist/index.js", "@zhongchongba/euler-tui");
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	const piAiCompatEntry = resolveWorkspaceOrImport("ai/dist/compat.js", "@zhongchongba/euler-ai/compat");
	const piAiOauthEntry = resolveWorkspaceOrImport("ai/dist/oauth.js", "@zhongchongba/euler-ai/oauth");
	const piAiProvidersEntry = resolveWorkspaceOrImport(
		"ai/dist/providers/all.js",
		"@zhongchongba/euler-ai/providers/all",
	);

	_aliases = {
		"euler-agent": piCodingAgentEntry,
		"@zhongchongba/euler-agent-core": piAgentCoreEntry,
		"@zhongchongba/euler-tui": piTuiEntry,
		"@zhongchongba/euler-ai/providers/all": piAiProvidersEntry,
		"@zhongchongba/euler-ai/compat": piAiCompatEntry,
		"@zhongchongba/euler-ai/oauth": piAiOauthEntry,
		"@zhongchongba/euler-ai": piAiCompatEntry,
