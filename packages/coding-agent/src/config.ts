...
import { EULER_ENV, getEulerEnv } from "./euler-env.ts";
...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/zhuchongba-01/euler/releases/latest`;
	}
...
export function getPackageDir(): string {
	...
	const envDir = getEulerEnv("packageDir");
	if (envDir) {
...
export const ENV_SESSION_DIR = EULER_ENV.sessionDir;
...
// =============================================================================
// User Config Paths (~/.euler/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.euler/agent/) */
