...
import {
	type BrowserCookieDiagnosticDetails,
	type CookieMap,
	getGoogleCookies,
	getLastGoogleCookieDiagnostic,
	getLastGoogleCookieDiagnosticDetails,
} from "./chrome-cookies.ts";
import {
	getBrowserCookieSelectionFromConfig,
...
export function createGeminiFetch(undiciImpl: typeof undici): typeof fetch {
