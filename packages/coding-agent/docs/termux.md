...
Euler runs on Android via [Termux](https://termux.dev/), a terminal emulator and Linux environment for Android.
...
Create `~/.euler/agent/AGENTS.md` to help the agent understand the Termux environment:
