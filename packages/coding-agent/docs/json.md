...
```bash
euler --mode json "Your prompt"
```

Outputs all session events as JSON lines to stdout. Useful for integrating euler into other tools or custom UIs.

## Event Types

Wire events use `JsonAgentSessionEvent`. It matches
[`AgentSessionEvent`](https://github.com/zhuchongba-01/euler/blob/main/packages/coding-agent/src/core/agent-session.ts)
...
[`AgentEvent`](https://github.com/zhuchongba-01/euler/blob/main/packages/agent/src/types.ts):
...
Base messages from [`packages/ai/src/types.ts`](https://github.com/zhuchongba-01/euler/blob/main/packages/ai/src/types.ts#L134):
- `UserMessage` (line 134)
- `AssistantMessage` (line 140)
- `ToolResultMessage` (line 152)

Extended messages from [`packages/coding-agent/src/core/messages.ts`](https://github.com/zhuchongba-01/euler/blob/main/packages/coding-agent/src/core/messages.ts#L29):
...
```bash
euler --mode json "List files" 2>/dev/null | jq -c 'select(.type == "message_end")'
```
