...
[`AgentSessionEvent`](https://github.com/euler-agent/euler/blob/main/packages/coding-agent/src/core/agent-session.ts)
...
[`AgentEvent`](https://github.com/euler-agent/euler/blob/main/packages/agent/src/types.ts):
...
Base messages from [`packages/ai/src/types.ts`](https://github.com/euler-agent/euler/blob/main/packages/ai/src/types.ts#L134):
- `UserMessage` (line 134)
- `AssistantMessage` (line 140)
- `ToolResultMessage` (line 152)

Extended messages from [`packages/coding-agent/src/core/messages.ts`](https://github.com/euler-agent/euler/blob/main/packages/coding-agent/src/core/messages.ts#L29):
