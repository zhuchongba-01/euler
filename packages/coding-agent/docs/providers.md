...
Reference for environment variables and `auth.json` keys: [`const envMap`](https://github.com/euler-agent/euler/blob/main/packages/ai/src/env-api-keys.ts) in [`packages/ai/src/env-api-keys.ts`](https://github.com/euler-agent/euler/blob/main/packages/ai/src/env-api-keys.ts).
